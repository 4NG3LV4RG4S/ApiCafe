...
using System.Text;
using Ixhuatlan.E_Coffe.Backend.AuthorizationUseCase;
using Ixhuatlan.E_Coffe.Backend.Entities.Options;
...
internal static class ServicesConfigurations
{
    public static WebApplication ConfigurationServices(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.Configure<AuthorizationOptions>(builder.Configuration.GetSection("Authentication"));

        builder.Services.AddAuthorizationToken();
